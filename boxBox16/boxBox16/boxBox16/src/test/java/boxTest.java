...
public class boxTest
{
    ...
    public void testUnit16()
    {
      try {
          aBox.work(10,20,60);
          assertEquals(3, aBox.p, 0.001);
          assertEquals(82, aBox.ap, 0.001);
      } catch (Exception e) {
          System.out.println("test catch");
      }
    }
    ...
    public void testUnit22remakeOnceNotchesFixed()
    {
        try {
            ...
            assertEquals(right, "Hello World!");
        } catch (Exception e) {
            System.out.println("test catch");
        }
    }
    ...
    public void testUnit25remakeOnceNotchesFixed()
    {
        ...
        @Test
    public void testUnit26remakeOnceNotchesFixed()
    {
        try {
            aBox.work(1,1,1);
            String right = "<g id=\"floor\" style=\"fill:none;stroke-linecap:round;stroke-linejoin:round;\">\n" +
    ...
    @Test
    public void testUnit27remakeOnceNotchesFixed()
    {
        try {
            aBox.work(1,1,1);
            String right = "<g id=\"floor\" style=\"fill:none;stroke-linecap:round;stroke-linejoin:round;\">\n" +
    ...
    @Test
    public void testUnit28()
    {
      try {
        aBox.work(4,1,20);
        assertEquals(16, aBox.w*4, 0.001);
        assertEquals(4, aBox.l*4, 0.001);
      } catch (Exception e) {
          System.out.println("test catch");
      }
    }
    ...
    @Test
    public void testUnit29()
    {
      try {
        aBox.work(30,10,20);
        assertEquals(120, aBox.w*4, 0.001);
        assertEquals(40, aBox.l*4, 0.001);
      } catch (Exception e) {
          System.out.println("test catch");
      }
    }
    ...
    @Test
    public void testUnit30()
    {
      try {
        aBox.work(10,5,20);
        assertEquals(40, aBox.w*4, 0.001);
        assertEquals(20, aBox.l*4, 0.001);
      } catch (Exception e) {
          System.out.println("test catch");
      }
    }
