  ...
  public static void work(double wi, double le, double he)
  {
    try {
      ...
      try {
      	...
      	double height = he * 6.35;
      	double width = wi * 6.35;
      	double length = le * 6.35;

        //double addPos = width + 2.0;
        double addPos = (length * 4) + 5.0;
        double point = 3.0;
        double leftPoint = 3.0;
        ...
        pieces[0] = ("<g id=\"floor\" style=\"fill:none;stroke-linecap:round;stroke-linejoin:round;\">\n" +
                             "<path d=\"M " + leftPoint + " " + point + " h " + width + " v 6.25 h " + width/2.5 + " v -6.25 h " +width/2.5+ " v 6.25 h " + width/2.5+ " v -6.25 h " +width/2.5+ " v 6.25 h " + width/2.5 + " v -6.25 h " + width + 
                             " v "+length+" h -6.25 v "+length/2.5+" h 6.25 v "+length/2.5+" h -6.25 v "+length/2.5+" h 6.25 v "+length/2.5+" h -6.25 v "+length/2.5+" h 6.25 v " + length + 
                             " h -" + width + " v -6.25 h -" + width/2.5 + " v 6.25 h -" +width/2.5+ " v -6.25 h -" + width/2.5+ " v 6.25 h -" +width/2.5+ " v -6.25 h -" + width/2.5 + " v 6.25 h -" + width + 
                             " v -"+length+" h 6.25 v -"+length/2.5+" h -6.25 v -"+length/2.5+" h 6.25 v -"+length/2.5+" h -6.25 v -"+length/2.5+" h 6.25 v -"+length/2.5+" h -6.25 v -" + length + 
        ...
        if(point + addPos > 320)
        {
          leftPoint += multiplier * 4 + 2;
          point = 3;
          multiplier = height + 2;
        }//this part isnt really tested

        pieces[1] = ("<g id=\"length1\" style=\"fill:none;stroke-linecap:round;stroke-linejoin:round;\">\n" +
                             "<path d=\"M " + leftPoint + " " + point + " h " + height + " v 6.25 h " + height/2.5 + " v -6.25 h " +height/2.5+ " v 6.25 h " + height/2.5+ " v -6.25 h " +height/2.5+ " v 6.25 h " + height/2.5 + " v -6.25 h " + height + 
                             ...
                             " h -" + height + " v -6.25 h -" + height/2.5 + " v 6.25 h -" +height/2.5+ " v -6.25 h -" + height/2.5+ " v 6.25 h -" +height/2.5+ " v -6.25 h -" + height/2.5 + " v 6.25 h -" + height + 
                             " v -"+length+" h -6.25 v -"+length/2.5+" h 6.25 v -"+length/2.5+" h -6.25 v -"+length/2.5+" h 6.25 v -"+length/2.5+" h -6.25 v -"+length/2.5+" h 6.25 v -" + length + 
                             " \" stroke=\"rgb(0,0,0)\" stroke-width=\"0.20\" />\n" +
                             "</g>\n" + 
                             "<circle cx=\"" + (leftPoint + (height*4) + height/8) + "\" cy=\"" + (point + length/4) + "\" r=\"" + (height/13) + "\" />");
        point += addPos;
        ...
        pieces[3] = ("<g id=\"width1\" style=\"fill:none;stroke-linecap:round;stroke-linejoin:round;\">\n" +
                             ...
                             " v  " + (width*4)+ 
                             " h -" + height + " v 6.25 h -" + height/2.5 + " v -6.25 h -" +height/2.5+ " v 6.25 h -" + height/2.5+ " v -6.25 h -" +height/2.5+ " v 6.25 h -" + height/2.5 + " v -6.25 h -" + height + 
                             " v -"+width+" h -6.25 v -"+width/2.5+" h 6.25 v -"+width/2.5+" h -6.25 v -"+width/2.5+" h 6.25 v -"+width/2.5+" h -6.25 v -"+width/2.5+" h 6.25 v -" + width + 
                             " \" stroke=\"rgb(0,0,0)\" stroke-width=\"0.20\" />\n" +
                             "</g>\n");
        point += addPos;
        ...
        pieces[5] = ("<g id=\"floor\" style=\"fill:none;stroke-linecap:round;stroke-linejoin:round;\">\n" +
                             ...
                             " v " + height/13 + " h -" + 6.25 + " v " + length/10 + " h " + 6.25 + " v " + ((length*4) - (height/13 + length/10)) + 
                             " h -"+width * 4  +
                             " v -"+((length*4) - (height/13 + length/10)) + " h " + 6.25 + " v -" + length/10 + " h -" + 6.25 + " v -" + height/13 +  
                             " \" stroke=\"rgb(0,0,0)\" stroke-width=\"0.20\" />\n" +
                             "</g>\n");
        //pieces[6] = ("<circle cx=" + 10 + " cy=" + 90 + " r=" + 2 + " />");
