    ...
    try {
      ...
      try {
        ...
        pieces[0] = ("<g id=\"floor\" style=\"fill:none;stroke-linecap:round;stroke-linejoin:round;\">\n" +
                             "<path d=\"M " + leftPoint + " " + point + " h " + width + " v 1 h " + width/2.5 + " v -1 h " +width/2.5+ " v 1 h " + width/2.5+ " v -1 h " +width/2.5+ " v 1 h " + width/2.5 + " v -1 h " + width + 
                             " v "+length+" h -1 v "+length/2.5+" h 1 v "+length/2.5+" h -1 v "+length/2.5+" h 1 v "+length/2.5+" h -1 v "+length/2.5+" h 1 v " + length + 
                             " h -" + width + " v -1 h -" + width/2.5 + " v 1 h -" +width/2.5+ " v -1 h -" + width/2.5+ " v 1 h -" +width/2.5+ " v -1 h -" + width/2.5 + " v 1 h -" + width + 
                             " v -"+length+" h 1 v -"+length/2.5+" h -1 v -"+length/2.5+" h 1 v -"+length/2.5+" h -1 v -"+length/2.5+" h 1 v -"+length/2.5+" h -1 v -" + length + 
        ...
        pieces[1] = ("<g id=\"length1\" style=\"fill:none;stroke-linecap:round;stroke-linejoin:round;\">\n" +
                             "<path d=\"M " + leftPoint + " " + point + " h " + height + " v 1 h " + height/2.5 + " v -1 h " +height/2.5+ " v 1 h " + height/2.5+ " v -1 h " +height/2.5+ " v 1 h " + height/2.5 + " v -1 h " + height + 
                             " v " + (length*4) + 
                             " h -" + height + " v -1 h -" + height/2.5 + " v 1 h -" +height/2.5+ " v -1 h -" + height/2.5+ " v 1 h -" +height/2.5+ " v -1 h -" + height/2.5 + " v 1 h -" + height + 
                             " v -"+length+" h -1 v -"+length/2.5+" h 1 v -"+length/2.5+" h -1 v -"+length/2.5+" h 1 v -"+length/2.5+" h -1 v -"+length/2.5+" h 1 v -" + length + 
                             " \" stroke=\"rgb(0,0,0)\" stroke-width=\"0.20\" />\n" +
                             "</g>\n");
        point += addPos;
        ...
        pieces[3] = ("<g id=\"width1\" style=\"fill:none;stroke-linecap:round;stroke-linejoin:round;\">\n" +
                             ...
                             " v  " + (width*4)+ 
                             " h -" + height + " v 1 h -" + height/2.5 + " v -1 h -" +height/2.5+ " v 1 h -" + height/2.5+ " v -1 h -" +height/2.5+ " v 1 h -" + height/2.5 + " v -1 h -" + height + 
                             " v -"+width+" h -1 v -"+width/2.5+" h 1 v -"+width/2.5+" h -1 v -"+width/2.5+" h 1 v -"+width/2.5+" h -1 v -"+width/2.5+" h 1 v -" + width + 
                             " \" stroke=\"rgb(0,0,0)\" stroke-width=\"0.20\" />\n" +
                             "</g>\n");
        point += addPos;
